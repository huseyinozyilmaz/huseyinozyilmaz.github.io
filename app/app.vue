<template>
  <div class="m-auto lg:max-w-225 px-3">
    <header class="flex flex-col md:flex-row text-center py-3 md:mt-3 font-mono">
      <h1 title="Site Name" class="mt-1">
        <NuxtLink to="/" class="flex gap-2 justify-center">
          ...
          <span class="h-8 leading-7 hidden md:block">{{ app.profile.shortName }}</span>
        </NuxtLink>
      </h1>
    ...
    <footer class="text-center text-xs bg-white py-3 fixed bottom-0 left-0 right-0">
